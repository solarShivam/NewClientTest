...
// import {navbarLinks} from '../../Components/Constants/index'
...
//                 />
//                 {!collapsed && <p className="text-lg font-medium text-slate-900 transition-colors dark:text-slate-50">Galo Score</p>}
//             </div>
...
import logoDark from "../../assets/logo-dark.svg";
import PropTypes from "prop-types";
import { useAuth } from "../../Components/Context/LoginContex"; // ✅ get user role
...
export const Sidebar = forwardRef(({ collapsed }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col gap-y-4 overflow-y-auto overflow-x-hidden p-3 [scrollbar-width:_thin]">
        {navbarLinks.map((navbarLink) => {
          const filteredLinks = navbarLink.links.filter(
