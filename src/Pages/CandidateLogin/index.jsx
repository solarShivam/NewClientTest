...
//   try {
//     if (mode === "login") {
//       const response = await fetch(`${import.meta.env.VITE_SERVER_ADDRESS}/candidate/candidate-login`, {
//         method: "POST",
//         headers: {
...
// const login = useGoogleLogin({
//   flow: 'implicit', // Important to enable id_token
...
//     const res = await fetch(`${import.meta.env.VITE_SERVER_ADDRESS}/candidate/candidate-login`, {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//       },
...
//         credential: response.credential, // ✅ this is the correct JWT
//       }),
//     });
...
//       <div className={`h-screen w-full ${isDark ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
        
        

//         {/* Middle Section */}
//         <div className=" flex flex-col md:flex-row" style={{ backgroundColor: "#FDC700" }}>
...
//       body: JSON.stringify({
//         clientId: `${import.meta.env.VITE_GOOGLE_CLIENT_ID}`,
//         credential: credentialResponse.credential, // this is the id_token (JWT)
//       }),
//     });
              ...
              {mode === "signup" && (
                <div>
                  ...
                  <input
                    ...
                    placeholder="Confirm Password..."
                    className={`w-full py-2 px-4 border-2 rounded-lg focus:outline-none ${
                      isDark
